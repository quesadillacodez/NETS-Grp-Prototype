...
const DEFAULT_USERS: User[] = [
  ...
  { id: 'merchant-kopi', loginId: 'kopitiammerchant', name: 'Kopitiam Merchant', avatar: '🏪', phone: 'Merchant Portal', role: 'merchant', merchantId: 'kopi' },
];
...
export function getPayableUsers(): User[] {
  return getAllUsers().filter(u => !isAdminUser(u) && !isMerchantUser(u));
}
